...
ISP Moodle 5.2 compatibility port
---------------------------------
This checkout includes a local compatibility port of the official
`MOODLE_501_STABLE` release at commit
`4b0be553267f853c1996288ad501722574b74750`. The local version only widens the
declared support range after validation against Moodle 5.2; compatibility
fixes, if required, are maintained in this project.
